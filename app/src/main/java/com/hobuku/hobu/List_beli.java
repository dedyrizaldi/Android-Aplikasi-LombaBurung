...
public class List_beli extends ListActivity {
String ip="";
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		SharedPreferences sharedPref = PreferenceManager.getDefaultSharedPreferences(List_beli.this);
		...
		lv.setOnItemClickListener(new OnItemClickListener() {
			...
			public void onItemClick(AdapterView<?> parent, View view,int position, long id) {
				...
				Intent i = new Intent(getApplicationContext(), Detail_beliApprove.class);
				i.putExtra("pk", pk);
	...
	class load extends AsyncTask<String, String, String> {
		...
		protected void onPreExecute() {
			super.onPreExecute();
			pDialog = new ProgressDialog(List_beli.this);
			...
			try {
				...
				if (sukses == 1) {
					...
					for (int i = 0; i < myJSON.length(); i++) {
						...
						String kode_jual = c.getString(TAG_kode_beli)+" - "+c.getString("jenis_burung");
						String tanggal_beli = c.getString(TAG_tanggal_beli)+" - "+c.getString("jam_beli")+" wib #"+c.getString("status_beli");
...
//					startActivity(i);
		...
		protected void onPostExecute(String file_url) {
			...
			runOnUiThread(new Runnable() {
				public void run() {
					ListAdapter adapter = new SimpleAdapter(List_beli.this, arrayList,R.layout.desain_list, new String[] { TAG_kode_beli,TAG_kode_jual, TAG_tanggal_beli,},new int[] { R.id.kode_k, R.id.txtNamalkp ,R.id.txtDeskripsilkp});
