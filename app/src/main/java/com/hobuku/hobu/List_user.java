	...
	class load extends AsyncTask<String, String, String> {
			...
			try {
				...
				if (sukses == 1) {
					...
					for (int i = 0; i < myJSON.length(); i++) {
						...
						String email = c.getString(TAG_email) +" - "+c.getString("telpon");
		...
		protected void onPostExecute(String file_url) {
			...
			runOnUiThread(new Runnable() {
				public void run() {
					ListAdapter adapter = new SimpleAdapter(List_user.this, arrayList,R.layout.desain_list, new String[] { TAG_kode_user,TAG_nama_user, TAG_email,},new int[] { R.id.kode_k, R.id.txtNamalkp ,R.id.txtDeskripsilkp});
