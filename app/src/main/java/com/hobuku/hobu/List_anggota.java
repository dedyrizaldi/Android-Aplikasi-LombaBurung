...
public class List_anggota extends ListActivity {
String ip="";
	...
	class load extends AsyncTask<String, String, String> {
		...
		protected void onPreExecute() {
			super.onPreExecute();
			pDialog = new ProgressDialog(List_anggota.this);
				...
				if (sukses == 1) {
					...
					for (int i = 0; i < myJSON.length(); i++) {
						...
						HashMap<String, String> map = new HashMap<String, String>();
							map.put(TAG_kode_anggota, kode_anggota);
							map.put(TAG_nama_anggota, nama_anggota);
		...
		protected void onPostExecute(String file_url) {
			...
			runOnUiThread(new Runnable() {
				public void run() {
					ListAdapter adapter = new SimpleAdapter(List_anggota.this, arrayList,R.layout.desain_list, new String[] { TAG_kode_anggota,TAG_nama_anggota, TAG_alamat,},new int[] { R.id.kode_k, R.id.txtNamalkp ,R.id.txtDeskripsilkp});
