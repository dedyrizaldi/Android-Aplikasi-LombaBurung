...
public class UploadToServer extends Activity {
    String myip="",gbupload="",gbupload2,gbupload3,gbupload4,gbupload5,gb;
    ...
    public int uploadFiles(String sourceFileUri) {
        ...
        else
        {
            try {
                ...
                if(gb.equalsIgnoreCase("1")){
                	gbupload=cc.getName();
                }
                else                if(gb.equalsIgnoreCase("2")){
                	gbupload2=cc.getName();
                }
                else                if(gb.equalsIgnoreCase("3")){
                	gbupload3=cc.getName();
                }
                else                if(gb.equalsIgnoreCase("4")){
                    gbupload4=cc.getName();
                }
                else                if(gb.equalsIgnoreCase("5")){
                    gbupload5=cc.getName();
                }
            ...
            i.putExtra("kode_burung", kode_burung);
